		...
		//setTimeout(function () {	// <-- Simulate network congestion, remove setTimeout from production!
			...
			$.getJSON(url, function(data) {			
				for (i=0; i<data.count; i++) {
					...
					var html='<div class="list_item"><a href="index.php?_c=goods&_a=detail&id='+data.events[i]["event_id"]+'"><img src="'+data.events[i]["pic_link"]+'"> '+hot+gleft+' </a> <div><font color="#009933">$'+data.events[i]["fanli"]+'</font><span>price<br>$ '+data.events[i]["price"]+'</span></div></div>';
